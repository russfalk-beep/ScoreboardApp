const Baseball = {
    ...
    addBall() {
        ...
        if (this.state.balls >= 4) {
            ...
            // Walk - auto advance not implemented, just reset count
        }
        this.updateDisplay();
    },
    ...
    updateDisplay() {
        ...
        this.updateDots('bb-balls', this.state.balls, 3);
        this.updateDots('bb-strikes', this.state.strikes, 2);
        this.updateDots('bb-outs', this.state.outs, 2);
    ...
    updateDots(containerId, count, max) {
    ...
    updateLineScore() {
        ['away', 'home'].forEach(side => {
            ...
            for (let i = 0; i < 9; i++) {
                ...
                totalR += this.state.inningScores[side][i];
            }
